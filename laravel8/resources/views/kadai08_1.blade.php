...
<div class="bg-white py-6 sm:py-8 lg:py-12">
    <div class="max-w-screen-2xl px-4 md:px-8 mx-auto">
        ...
        <!-- text - end -->
        <!-- form - start -->
        <form action="/kadai06_1" enctype="multipart/form-data" method="POST" class="max-w-screen-md grid sm:grid-cols-2 gap-4 mx-auto">
            @csrf
            <div>
            ...
            <div class="sm:col-span-2 flex justify-between items-center">
                <button
                    class="inline-block bg-indigo-500 hover:bg-indigo-600 active:bg-indigo-700 focus-visible:ring ring-indigo-300 text-white text-sm md:text-base font-semibold text-center rounded-lg outline-none transition duration-100 px-8 py-3">新規作成</button>
